...
<template>
  <div>
    <div style="min-height: 93.7vh" class="flex items-center justify-center w-full min-h-screen">
      <div class="flex flex-col text-gray-700 lg:flex-row lg:space-x-16 lg:space-x-reverse">
        <div class="order-1 max-w-md px-2 text-sm md:text-base lg:px-0">
          <header class="mb-6">
            ...
            <h3 class="text-xl font-light leading-normal lg:text-3xl md:text-3xl dark:text-white">
              Sorry, we couldn't find this page.
            </h3>
          </header>

          <p class="max-w-sm mb-5 leading-5 md:leading-7 dark:text-white">
            Don't worry, sometimes even we make mistakes. You can find plenty of other things on our
            homepage.
          </p>
